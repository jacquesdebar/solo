      ...
      <div className="row my-4">
        <div className="col-12">
          ...
          <h3 className="team mb-3">
            ...
            , and{" "}
            <a className="teammate" href="https://www.linkedin.com/in/hilt/">
              Hilton Vo
            </a>
            .
          </h3>
          <div className="row justify-content-center">
            <Img
              src="/SOLSTICE1/SOLSTICE1-05.jpg"
              alt="SportsPrediction screencaps"
              style={{ width: "100%", marginBottom: 24 }}
            />
            <Img
              src="/SOLSTICE1/SOLSTICE1-06.jpg"
              alt="SportsPrediction screencaps"
              style={{ width: "100%", marginBottom: 24 }}
            />
            <Img
              src="/SOLSTICE1/SOLSTICE1-07.jpg"
              alt="SportsPrediction screencaps"
              style={{ width: "100%", marginBottom: 24 }}
            />
            <Img
              src="/SOLSTICE1/SOLSTICE1-08.jpg"
              alt="SportsPrediction screencaps"
              style={{
                width: "100%",
                marginBottom: 24,
            ...
            />
            <Img
              src="/SOLSTICE1/SOLSTICE1-10.jpg"
              alt="SportsPrediction screencaps"
              style={{ width: "100%", marginBottom: 24 }}
            />
            <Img
              src="/SOLSTICE1/SOLSTICE1-11.jpg"
              alt="SportsPrediction screencaps"
              style={{ width: "100%", marginBottom: 24 }}
            />
            <Img
              src="/SOLSTICE1/SOLSTICE1-12.jpg"
              alt="SportsPrediction screencaps"
              style={{ width: "100%", marginBottom: 24 }}
            />
          </div>
          <div className="mt-2">
            ...
            <p>
              ...
              function. Solstice helps you reach your high points and supports
              you through your low points through promoting healthy interactions
              with your device, aiming to limit the feelings of distraction and
