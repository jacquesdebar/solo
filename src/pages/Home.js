      ...
      <div className="row">
        <div className="col-12">
          ...
          <p>
            ...
            <a href="https://ischool.uw.edu/programs/informatics" target="_blank" rel="noopener noreferrer">
              informatics program
            </a>
            ...
            <a href="https://www.instagram.com/iu.band/" target="_blank" rel="noopener noreferrer">i///u</a> as well as my
            friends at{" "}
            <a href="https://www.instagram.com/h_mancondition/" target="_blank" rel="noopener noreferrer">
              Human Condition
            </a>{" "}
            and <a href="https://www.instagram.com/possilife/" target="_blank" rel="noopener noreferrer">Possi</a> for
            ...
            <br />
            <br />
            Here's what I've been listening to recently <a className="" href="/go" target="_blank" rel="noopener noreferrer"><i class="fas fa-external-link-alt" aria-label="open in new tab"></i></a>. You can contact me at{" "}
