      ...
      competing against other players to see who is the best predictor */}
            ...
            <div className="row my-5">
                <div className="col-12">
                    ...
                    <div className="mt-2">
                        <p>
                            I made the BROCKHAMPTON infographic depicted above to showcase the diverse roster of
                            creatives that make up the group. BROCKHAMPTON is a musical collective that has risen to
                            prominence over the past few years. Their music is centered around hip-hop and alternative
                            elements, and explores themes of mental health, fame, and representation, among much else. I
                            made this infographic in Adobe Illustrator, with many revisions to each component through a
                            series of critiques from my classmates. I documented much of this process in{" "}
                            <a href="https://jacquesdebar.wixsite.com/website-83">its own Wix site</a>, and explained
                            many of my design choices in a{" "}
                            <a href="https://youtu.be/98AOGUEQrMo">comprehensive video</a>. This infographic was part of
                            my INFO 362 (Visual Information Design) class.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="row my-5">
                <div className="col-12">
                    <a href="http://students.washington.edu/jdebar/kiosk.html">
                        <h2 className="mb-2">Husky Kiosk</h2>
                    </a>
                    <h3 className="team mb-3">
                        with{" "}
                        <a className="teammate" href="https://www.linkedin.com/in/bnguyen12/">
                            Benny Nguyen
                        </a>{" "}
                        and{" "}
                        <a className="teammate" href="https://www.linkedin.com/in/nicola-kalderash-bba38256/">
                            Nicola Kalderash
                        </a>
                        .
                    </h3>
                    ...
                    <div className="mt-2">
                        <p>
                            Husky Kiosk focuses on empowering formerly-incarcerated students at the University of
                            Washington. Formerly-incarcerated people are one of the most marginalized and
                            underrepresented demographics, particularly in higher education. Because of this, we sought
                            to become allies and find a way for information technology to ease the undue burden on
                            system-impacted people. After consulting many stakeholders, including formerly-incarcerated
                            students themselves, we laid out a model for a physical space to serve as a gathering place
                            and safe space for the system-impacted community at UW. In addition to this, we built an
                            website to host informational resources to help provide information and education about
                            topics of housing, finance, the UW landscape, and other resources pertinent to our
                            stakeholders. This project was initially created for our INFO 360 (Design Inquiry) class.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="row my-5">
                <div className="col-12">
                    ...
                    <h3 className="team mb-3">
                        with{" "}
                        <a className="teammate" href="https://www.linkedin.com/in/robert-lin1/">
                            Robi Lin
                        </a>
                        ,{" "}
                        <a className="teammate" href="https://www.linkedin.com/in/oscar-avatare/">
                            Oscar Avatare
                        </a>
                        , and{" "}
                        <a className="teammate" href="https://www.linkedin.com/in/lucas-woo-84103966/">
                            Lucas Woo
                        </a>
                        .
                    </h3>
                    ...
                    <div className="mt-2">
                        <p>
                            Swordfish is an econometrics app centered built around stock regression. Since the stock
                            market is so pervasive in our lives with the news, our retirement portfolios, and personal
                            employment considerations, we figured building a tool to give users a little more insight
                            into it would be very worthwhile, would be a great way to demonstrate how front-end and
                            back-end programming could be brought together at a basic level. With Swordfish, users are
                            able to see the relationships between a stock of their choice (such as AAPL, AMZN, TSLA,
                            etc.) and a wide array of economic variables. This web app was made for our INFO 360
                            (Client-Side Web Development) class.
                        </p>
                    </div>
                </div>
            </div>
          ...
          <Img src="/spDevices.png" className style={{width:"50%"}} />
            ...
            <div className="row my-5">
                <div className="col-12">
                    ...
                    <h3 className="team mb-3">
                        with{" "}
                        <a className="teammate" href="https://www.linkedin.com/in/amahoneyfernandes/">
                            Andrew Mahoney-Fernandes
                        </a>
                        ,{" "}
                        <a className="teammate" href="https://www.linkedin.com/in/pulith-silva-34726a117/">
                            Pulith Silva Gangavarapu
                        </a>
                        , and{" "}
                        <a className="teammate" href="https://www.linkedin.com/in/james-lee-5a992a115/">
                            James Lee
                        </a>
                        .
                    </h3>
                    ...
                    <div className="mt-2">
                        <p>
                            For my INFO 201 (Technological Foundations) course, I worked with a team to build an R shiny
                            app studying potential correlations between Google search volume for cryptocurrencies and
                            the cryptocurrencies' prices. Our group wanted to look at the relation of Google keyword
                            search and historical cryptocurrency market prices had on each other. We pulled data
                            resources from various users and locations, cleaned that dataset to fit our study, then
                            hosted our visualizations as shiny app. To answer the question of whether or not higher
                            query hits of cryptocurrency keywords relates to a higher crypto- market value, we built a
                            visualization containing two types of graphs and a filtering section to match the focus of
